-- ============================================================================
-- FEALuxe feature expansion:
--   • roles / admin (secure has_role pattern)
--   • wishlist
--   • product reviews + rating aggregates
--   • coupons + order discount columns
--   • automatic stock decrement on order
--   • admin management RLS policies
-- ============================================================================

-- ---------------------------------------------------------------------------
-- Roles (never stored on profiles — separate table to prevent privilege escalation)
-- ---------------------------------------------------------------------------
...
-- Every new user becomes a 'customer' automatically.
...
-- Denormalised rating summary on products for fast catalog rendering.
...
-- ---------------------------------------------------------------------------
-- Coupons (validated server-side via service role; not client-readable)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Automatic stock decrement when an order line is created
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Admin management policies (via has_role)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- NOTE: grant yourself admin after signing up by running (with service role):
--   insert into public.user_roles (user_id, role)
