...
export const Route = createFileRoute("/products/")({
  head: () => ({
    meta: [
      { title: "Shop — FEA Glam" },
      { name: "description", content: "Browse premium makeup, skincare, haircare, fragrances and beauty accessories at FEA Glam." },
      { property: "og:title", content: "Shop — FEA Glam" },
    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="border-b border-border bg-gradient-to-b from-secondary/50 to-background">
        <div className="container-luxe py-12 md:py-16">
          <p className="text-xs font-medium uppercase tracking-widest text-primary">FEA Glam Collection</p>
