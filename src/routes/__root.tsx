...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "FEALuxe" },
      { property: "og:title", content: "FEALuxe — Premium Beauty & Cosmetics" },
      { property: "og:description", content: "Discover luxury makeup, skincare, haircare, fragrances and beauty accessories at FEALuxe." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@fealuxe" },
      { name: "twitter:title", content: "FEALuxe — Premium Beauty & Cosmetics" },
      { name: "twitter:description", content: "Discover luxury makeup, skincare, haircare, fragrances and beauty accessories at FEALuxe." },
