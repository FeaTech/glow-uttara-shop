...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "FEALuxy — Premium Beauty & Cosmetics" },
      { name: "twitter:description", content: "Discover luxury makeup, skincare, haircare, fragrances and beauty accessories at FEALuxy." },
