...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "FEA Glam" },
      { property: "og:title", content: "FEA Glam — Premium Beauty & Cosmetics" },
      { property: "og:description", content: "Discover luxury makeup, skincare, haircare, fragrances and beauty accessories at FEA Glam." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@feaglam" },
      { name: "twitter:title", content: "FEA Glam — Premium Beauty & Cosmetics" },
      { name: "twitter:description", content: "Discover luxury makeup, skincare, haircare, fragrances and beauty accessories at FEA Glam." },
