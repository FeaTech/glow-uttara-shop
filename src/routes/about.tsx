...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About us — FEALuxy" },
      { name: "description", content: "FEALuxy curates authentic luxury beauty for India — the story behind the brand." },
    ],
  }),
  component: AboutPage,
});
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="container-luxe relative py-20 text-center md:py-28">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-muted-foreground">
            FEALuxy is a modern beauty destination bringing authentic luxury makeup, skincare, haircare, and
      ...
      <section className="container-luxe max-w-3xl py-16 md:py-20">
        <ScrollReveal className="space-y-6 text-lg leading-relaxed text-muted-foreground">
          <p>
            We started FEALuxy with a simple frustration: finding genuinely premium beauty in India often meant
