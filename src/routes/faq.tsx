...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQs — FEA Glam" },
      { name: "description", content: "Answers to common questions about shopping, shipping, returns, and payments at FEA Glam." },
    ],
  }),
  component: FaqPage,
});
...
const faqs = [
  { q: "Are all products 100% authentic?", a: "Yes. Every product sold on FEA Glam is sourced directly from authorised brands or distributors. We never sell counterfeit or grey-market goods." },
    ...
    <div className="min-h-screen bg-background">
      <div className="border-b border-border bg-gradient-to-b from-secondary/50 to-background">
        <div className="container-luxe py-16 text-center">
          ...
          <p className="mt-3 text-muted-foreground">Everything you need to know about shopping with FEA Glam.</p>
        </div>
      </div>
